...
I came across this question when I was reading the first chapter of the book 'Algorithms to Live By'. It's a famous problem that uses the optimal stopping theory. The problem has been studied extensively in the fields of statics, decision theory and applied probability. It's also known as secretary problem, marriage problem and the best choice problem.In any optimal problem, the crucial dilemma is not which option to *pick*, but how many options to even *consider*.
...
simulations <- simulations <- c(10,50,100,200,300,400,500,seq(1000,30000,1000))
result <- NULL
